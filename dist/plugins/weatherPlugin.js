...
class WeatherPlugin {
    constructor() {
        this.name = "Weather";
        this.description = "Get current weather information for any city using AI knowledge";
...
Provide realistic weather data based on the city's typical climate and current season.`;
            const completion = await this.openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: "system",
                        content: "You are a weather information assistant. Provide realistic weather data based on typical climate patterns for the requested location and current season. Always format responses as valid JSON.",
                    },
                    {
                        role: "user",
